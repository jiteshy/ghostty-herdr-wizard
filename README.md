...
**Steps 1 to 5: the terminal.** Install Ghostty and the JetBrains Mono Nerd Font. Write the Ghostty config: colors that follow macOS light and dark mode, and Cmd keys that control herdr. Make the Ctrl-Space key free for herdr.
